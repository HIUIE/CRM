      ...
      <section className="shrink-0 flex flex-col gap-4 p-1">
        <div className="flex items-center justify-between">
          ...
          <button 
            ...
            className="flex items-center gap-2 rounded-lg bg-primary-navy dark:bg-tertiary-sage px-5 py-2 text-xs font-bold text-white shadow-md hover:bg-slate-800 transition-all active:scale-95 uppercase tracking-widest"
          >
            <Plus size={16} /> 指派新任务
          </button>
        </div>
