...
export function Combobox({ value, onChange, onSearch, placeholder = '请选择...', disabled = false, className = '' }: ComboboxProps) {
  ...
  return (
    <div ref={containerRef} className={`relative w-full min-w-0 ${className}`}>
      ...
      {isOpen && (
        <div className="absolute z-[100] mt-2 w-full min-w-full rounded-lg border border-slate-200 dark:border-navy-700 bg-surface dark:bg-navy-900 shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
